...
t0 = time.time()
# open('results/MBTI2_LSTM_L1_EI_pilot1000.txt', 'w').close()
# with open('results/MBTI2_LSTM_L1_EI_pilot1000.txt', 'a') as f:
...
# # open('results/MBTI2_LSTM_L1_EI_pilot5000.txt', 'w').close()
# with open('results/MBTI2_LSTM_L1_EI_pilot5000.txt', 'a') as f:
...
open('results/MBTI2_LSTM_L1_EI.txt', 'w').close()
with open('results/MBTI2_LSTM_L1_EI.txt', 'a') as f:
