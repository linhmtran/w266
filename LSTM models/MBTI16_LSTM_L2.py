...
y_train_id, y_test_id = ds.label_to_id(mbti_type, label_train, label_test)
...
t0 = time.time()
# open('results/MBTI16_LSTM_L2_pilot1000.txt', 'w').close()
# with open('results/MBTI16_LSTM_L2_pilot1000.txt', 'a') as f:
...
# open('results/MBTI16_LSTM_L2_pilot5000.txt', 'w').close()
# with open('results/MBTI16_LSTM_L2_pilot5000.txt', 'a') as f:
...
open('results/MBTI16_LSTM_L2.txt', 'w').close()
with open('results/MBTI16_LSTM_L2.txt', 'a') as f:
