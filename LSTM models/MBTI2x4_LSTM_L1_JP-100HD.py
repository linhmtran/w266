...
# # MBTI Binary JP Classification w/ 1 Layer LSTM
# 
...
t0 = time.time()
# open('results/MBTI2_LSTM_L1_JP_100HD_pilot1000.txt', 'w').close()
# with open('results/MBTI2_LSTM_L1_JP_100HD_pilot1000.txt', 'a') as f:
...
# # open('results/MBTI2_LSTM_L1_JP_100HD_pilot5000.txt', 'w').close()
# with open('results/MBTI2_LSTM_L1_JP_100HD_pilot5000.txt', 'a') as f:
...
open('results/MBTI2_LSTM_L1_JP_100HD.txt', 'w').close()
with open('results/MBTI2_LSTM_L1_JP_100HD.txt', 'a') as f:
