...
t0 = time.time()
# open('results/MBTI2_LSTM_L1_JP_pilot1000.txt', 'w').close()
# with open('results/MBTI2_LSTM_L1_JP_pilot1000.txt', 'a') as f:
...
# # open('results/MBTI2_LSTM_L1_JP_pilot5000.txt', 'w').close()
# with open('results/MBTI2_LSTM_L1_JP_pilot5000.txt', 'a') as f:
...
open('results/MBTI2_LSTM_L1_JP.txt', 'w').close()
with open('results/MBTI2_LSTM_L1_JP.txt', 'a') as f:
