...
t0 = time.time()
# open('results/MBTI2_LSTM_L1_FT_100HD_pilot1000.txt', 'w').close()
# with open('results/MBTI2_LSTM_L1_FT_100HD_pilot1000.txt', 'a') as f:
...
# # open('results/MBTI2_LSTM_L1_FT_100HD_pilot5000.txt', 'w').close()
# with open('results/MBTI2_LSTM_L1_FT_100HD_pilot5000.txt', 'a') as f:
...
open('results/MBTI2_LSTM_L1_FT_100HD.txt', 'w').close()
with open('results/MBTI2_LSTM_L1_FT_100HD.txt', 'a') as f:
